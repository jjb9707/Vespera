...
export default function TenantDashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 font-sans text-slate-900 flex flex-col lg:flex-row">
      {/* Sidebar Component */}
      <Sidebar
          ...
          <div className="h-20 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="lg:hidden min-h-[44px] min-w-[44px] flex items-center justify-center p-2 -ml-2 text-slate-600 hover:bg-slate-100 rounded-xl transition-colors"
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="hidden md:flex relative w-64">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full pl-10 pr-4 py-2 bg-slate-100 border-none rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-slate-200 transition-all"
                />
              </div>
              ...
              <button className="hidden sm:flex items-center justify-center space-x-2 bg-blue-900 text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm">
                <Wallet size={16} />
